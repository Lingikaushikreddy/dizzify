...
import app.launcher.ui.components.SidebarDestination
import app.launcher.ui.components.LauncherSidebar
import app.launcher.ui.screens.AppsScreen
import app.launcher.ui.screens.GamesScreen
import app.launcher.ui.screens.HiddenAppsScreen
import app.launcher.ui.screens.HomeScreen
import app.launcher.ui.screens.SettingsScreen
import app.launcher.ui.theme.LauncherTheme
                ...
                NavDisplay(
                    ...
                    entryProvider = entryProvider {
                        entry<LauncherKey.Home> {
                            HomeScreen(
                                viewModel = viewModel,
                                onNavigateToApps = { backStack.clear(); backStack.add(LauncherKey.Apps) }
                            )
                        }
